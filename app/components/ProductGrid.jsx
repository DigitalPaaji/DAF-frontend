...
try {
 ...
 if(data.success){
  ...
  const handleAddToCart = (product) => {
    const cartItem = {
      ...product,
      selectedSize: product.sizes?.[0] || "100g",
      quantity: 1,
    };
  ...
  return (
    <section className="relative py-24 bg-[#F5F2EB] text-[#3A2A21] font-sans overflow-hidden">
      ...
      <img
        ...
        style={{
          clipPath:
            "polygon(100% 0, 100% 100%, 0 100%, 30% 0)",
        }}
      />
      ...
      <div className="px-4 md:px-12 xl:px-72 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Explore our premium tea blends, kitchen masalas, pickle
            masalas, pure spices, healthy flours, traditional pickles
            and ready-to-use tadka gravies.
          </motion.p>
